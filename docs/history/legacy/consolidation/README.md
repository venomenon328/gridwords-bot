...
**Status:** abgeschlossen und historisiert
...
- [x] Phase-1-Diff reviewen.

### Phase 2 – aktuelle Wahrheit erzeugen

- [x] `docs/product/` aus den neuesten gültigen Quellen erzeugen.
- [x] `docs/architecture/` gegen aktuellen Code und ADRs erzeugen.
- [x] `docs/development/` aus dem heute gültigen Leitfaden ableiten.
- [x] aktive Operations-Runbooks konsolidieren.
- [x] semantischen Vergleich gegen aktuellen produktiven 1.5.1-Stand durchführen.

### Phase 3 – Historisierung und Content-Umzug

- [x] alte Grundspezifikation nach `history/legacy/` verschieben.
- [x] Inkrementpläne nach `history/increments/` verschieben.
- [x] Acceptance-/Release-/Canary-Dokumente versionsbezogen historisieren.
- [x] `docs/editorial/` nach `content/excuses/` verschieben.
- [x] `tools/build_excuse_catalog.py` und zugehörige Tests auf neue Contentpfade umstellen.
- [x] ADR-Index anlegen; Superseded-Status korrigieren.

### Phase 4 – Einstiegspunkte und Konsistenz

- [x] `docs/README.md` als Dokumentationsindex erstellen.
- [x] Root-README auf Produktüberblick, Quick Start und Doku-Einstieg reduzieren.
- [x] `AGENTS.md` auf Arbeitsregeln und neue Dokumentautorität reduzieren.
- [x] `implementation-plan.md` durch kompakte Releasehistorie ersetzen und historisieren.
- [x] alle internen Markdownlinks und Toolpfade aktualisieren.
- [x] keine alten kanonischen Pfade mehr aus aktivem Code/Docs referenzieren.
