...
Die damaligen Grundlagen sind unter [`series-model.md`](../legacy/requirements/series-model.md), [`dynamic-player-model.md`](../legacy/requirements/dynamic-player-model.md) und [`daily-status-reminders.md`](../legacy/requirements/daily-status-reminders.md) erhalten; hinzu kommen Issue #21 und ADR 0012.
