...
- Status: akzeptiert
- Datum: 2026-08-03
- Kontext: Issue #42 und Zwischeninkrement 12.1

## Kontext

Kontextabhängige Ausreden sind ein freiwilliges Unterhaltungsfeature nach seltenen Ergebniskonstellationen. Der Nutzer erhält ephemer drei redaktionell gepflegte Vorschläge, kann einmal nach einem Stil neu würfeln, verzichten oder genau einen Text auswählen.
...
Die Umsetzung beginnt erst nach Abschluss der spielbezogenen Teilnahme aus Issue #39. Angebots- und Vergleichslogik verwendet ausschließlich die historisch wirksame Teilnehmermenge des betroffenen Spiels.
...
Die vollständige Fachsemantik steht in `docs/requirements/excuses.md`. Die paketweise Umsetzung steht in `docs/increments/12.1-contextual-excuses.md`.
