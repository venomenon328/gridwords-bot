...
Dieses Dokument ist die redaktionelle Buildquelle für allgemeine und `NOT_SOLVED`-Texte. Der deterministische Compiler überführt Texte, IDs und Metadaten in `src/main/resources/excuses/catalog.json`; Änderungen müssen die Katalog- und Qualitätsgates erfüllen.
