...
Dieses Dokument ist die redaktionelle Buildquelle für den Anlass `QUADWORDS_SINGLE_BOARD_COLLAPSE`. Der deterministische Compiler konsolidiert die Texte in den produktiven JSON-Katalog.
