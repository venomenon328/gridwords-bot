# Redaktioneller Ausredenkatalog

Dieser Ordner enthält die aktuellen redaktionellen Buildquellen, ihre Mengen, Qualitätsregeln und Review-Snapshots. Die fachliche Laufzeitsemantik steht unter [`../../docs/product/excuses.md`](../../docs/product/excuses.md).

## Gesamtbestand

| Familie | Datei | Anzahl |
|---|---|---:|
| Allgemein und `NOT_SOLVED` | [`drafts/general.md`](drafts/general.md) | 208 |
| `VERY_LATE_SUBMISSION` | [`drafts/very-late-submission.md`](drafts/very-late-submission.md) | 58 |
| `GRIDWORDS_LAST_ATTEMPT` | [`drafts/gridwords-last-attempt.md`](drafts/gridwords-last-attempt.md) | 56 |
| `GRIDWORDS_VERY_SLOW` | [`drafts/gridwords-very-slow.md`](drafts/gridwords-very-slow.md) | 56 |
| `QUADWORDS_VERY_SLOW` | [`drafts/quadwords-very-slow.md`](drafts/quadwords-very-slow.md) | 56 |
| `QUADWORDS_SINGLE_BOARD_COLLAPSE` | [`drafts/quadwords-single-board-collapse.md`](drafts/quadwords-single-board-collapse.md) | 72 |
| `CLEAR_CURRENT_DAILY_OUTLIER` | [`drafts/current-daily-outlier.md`](drafts/current-daily-outlier.md) | 58 |
| **Gesamt** |  | **564** |
...
| Datei | Funktion |
|---|---|
| [`quality-guidelines.md`](quality-guidelines.md) | verbindlicher Qualitätsmaßstab für Ausredenfunktion, Stil, Tatsachensicherheit und Dubletten |
| [`review/pass-1.md`](review/pass-1.md) | verbindliche Textersetzungen und Ergebnis des ersten Qualitätsdurchgangs |
| [`review/general-topic-map.md`](review/general-topic-map.md) | endgültige `ExcuseTopic`-Zuordnung der 144 allgemeinen Texte |
| [`../../docs/product/excuses.md`](../../docs/product/excuses.md) | fachlich aktueller Umfang und Auswahllogik |
| [`../../tools/build_excuse_catalog.py`](../../tools/build_excuse_catalog.py) | deterministische Erzeugung und Prüfung von `catalog.json` |
...
3. Eine explizite Ersetzung aus `review/pass-1.md`.
4. Ursprünglicher Text aus dem jeweiligen Familienentwurf.
5. Themenzuordnung aus `review/general-topic-map.md`.
...
Der Tagesausreißer-Block wurde vollständig nach diesem Maßstab geschärft. Weitere beschreibende Langsamkeits- und Allgemeintexte wurden gezielt überarbeitet. Die verbindlichen Einzeländerungen stehen in `review/pass-1.md`.
...
Die redaktionelle Texterstellung, der Qualitätsdurchgang, die Themenzuordnung, der deterministische Compiler, der produktive JSON-Katalog und die Laufzeitvalidierung sind vollständig umgesetzt.
