...
Dieser Durchgang prüft den Arbeitsbestand von 564 Ausreden gegen [`../quality-guidelines.md`](../quality-guidelines.md). Die Arbeitsdokumente bleiben die Primärquelle; die hier festgehaltenen Ersetzungen sind bei der Konsolidierung in den produktiven JSON-Katalog verbindlich, sofern sie nicht vorher direkt in das jeweilige Dokument eingearbeitet wurden.
