...
@Component
@Profile("database")
@ConditionalOnBean(MonthlyReportReconciliationService.class)
final class MonthlyReportScheduler {
    ...
    MonthlyReportScheduler(MonthlyReportReconciliationService reconciliation, GridwordsBotProperties properties) {
