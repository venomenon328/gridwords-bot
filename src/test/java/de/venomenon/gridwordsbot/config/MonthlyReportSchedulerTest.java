...
class MonthlyReportSchedulerTest {
    ...
    private static Fixture fixture() {
        MonthlyReportReconciliationService reconciliation = mock(MonthlyReportReconciliationService.class);
        ...
        return new Fixture(reconciliation, new MonthlyReportScheduler(reconciliation, properties));
    }

    private record Fixture(MonthlyReportReconciliationService reconciliation, MonthlyReportScheduler scheduler) { }
}
