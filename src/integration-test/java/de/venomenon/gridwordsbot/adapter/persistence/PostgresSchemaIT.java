...
class PostgresSchemaIT {
    ...
    @Test void liquibaseCreatesAllPersistenceTables() { assertEquals(8, jdbc.queryForObject("select count(*) from information_schema.tables where table_schema='public' and table_name in ('player','game_result','submission','submission_attachment','daily_status_message','canonical_delivery_attempt','game_result_excuse','game_result_excuse_option')", Integer.class)); }
